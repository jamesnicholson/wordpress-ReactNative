...
import {ISetLoading, ISetCategories, IGetCategories, IGetPosts, ISetPosts, ISetSearchTerm } from './interfaces';
...
type TAction = ISetLoading | ISetCategories | IGetCategories | ISetPosts | IGetPosts | ISetSearchTerm ;
